...
1. Научиться создавать и осуществлять конфигурацию РЗА-системы
...
1. Скачайте ПО [KIWI](http://i-mt.net/kiwi), запустите файл KIWI.exe (установка ПО не требуется)
...
1. [Шаблон для выполнения задания](https://docs.google.com/document/d/1fru6UrEYrEQdtbKysrhosNnEL8GvGMz62nVjH-7UarQ/edit?usp=sharing)
...
1. Отправлена ссылка на проект KIWI с выполненным заданием в личном кабинете.
2. Проект KIWI размещён на личном Google Диске.
3. К проекту KIWI настроены права доступа «Просматривать могут все в Интернете, у кого есть ссылка».
